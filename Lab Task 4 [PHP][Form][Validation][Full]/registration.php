...
<body>
                <fieldset>
                  ...
                  <form action="#" method="post">
                    <label for="">Name: </label><input type="text" name="name" value="">
                    <hr>
                    <label for="">Email: </label><input type="email" name="email" value="">
                    <hr>
                    <label for="">User Name: </label><input type="text" name="username" value="">
                    <hr>
                    <label for="">Password: </label><input type="password" name="password" value="">
                    <hr>
                    <label for="">Confirm Password: </label><input type="password" name="c_password" value="">
                    <hr>
                    <fieldset>
