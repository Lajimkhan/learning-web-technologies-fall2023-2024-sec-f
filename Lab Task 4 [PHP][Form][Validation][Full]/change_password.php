...
<body>
                ...
                <fieldset>
                    ...
                    <label for="">Current Password: </label><input type="password" name="current_password" value="">
                    <hr>
                    <span style="color: rgb(0, 128, 0);">New Password:  </span><input type="password" name="new_password" value="">
                    <hr>
                    <span style="color: rgb(255, 0, 0);">Retype New Password: </span><input type="password" name="retype_password" value="">
                    <hr>
